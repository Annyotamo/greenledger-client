        ...
        <div className="gl-card p-6">
            <div className="flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between">
                <div>
                    ...
                    <p className="mt-1 text-sm text-(--muted)">Add a factor to the database (Super Admin).</p>
                </div>
                    ...
                    <div className="rounded-2xl bg-white/60 p-4 ring-1 ring-black/5 shadow-[0_18px_50px_-45px_rgba(15,23,42,0.28)]">
                        ...
                        <div className="mt-3 grid grid-cols-1 gap-3 sm:grid-cols-2">
                            <div>
                                ...
                                />
                                {errors.facilityName ? (
                                    <div className="mt-1 text-[12px] text-red-600">{errors.facilityName}</div>
                                ) : null}
                            </div>
                            ...
                            <div>
                                ...
                                />
                                {errors.year ? (
                                    <div className="mt-1 text-[12px] text-red-600">{errors.year}</div>
                                ) : null}
                            </div>
                            ...
                            <div>
                                ...
                                />
                                {errors.fuelName ? (
                                    <div className="mt-1 text-[12px] text-red-600">{errors.fuelName}</div>
                                ) : null}
                            </div>
                            ...
                            <div>
                                ...
                                />
                                {errors.fuelType ? (
                                    <div className="mt-1 text-[12px] text-red-600">{errors.fuelType}</div>
                                ) : null}
                            </div>
                            ...
                            <div>
                                ...
                                />
                                {errors.unit ? (
                                    <div className="mt-1 text-[12px] text-red-600">{errors.unit}</div>
                                ) : null}
                            </div>
                            ...
                            <div>
                                ...
                                />
                                {errors.convertTo ? (
                                    <div className="mt-1 text-[12px] text-red-600">{errors.convertTo}</div>
                                ) : null}
                            </div>
                        </div>
                    ...
                    <div className="mt-6 rounded-2xl bg-white/60 p-4 ring-1 ring-black/5 shadow-[0_18px_50px_-45px_rgba(15,23,42,0.28)]">
                        ...
                        <div className="mt-3 grid grid-cols-1 gap-3 sm:grid-cols-2">
                            <div>
                                ...
                                />
                                {errors.co2eTotal ? (
                                    <div className="mt-1 text-[12px] text-red-600">{errors.co2eTotal}</div>
                                ) : null}
                            </div>
                            ...
                            <div>
                                ...
                                />
                                {errors.co2Factor ? (
                                    <div className="mt-1 text-[12px] text-red-600">{errors.co2Factor}</div>
                                ) : null}
                            </div>
                            ...
                            <div>
                                ...
                                />
                                {errors.ch4Factor ? (
                                    <div className="mt-1 text-[12px] text-red-600">{errors.ch4Factor}</div>
                                ) : null}
                            </div>
                            ...
                            <div>
                                ...
                                />
                                {errors.n2oFactor ? (
                                    <div className="mt-1 text-[12px] text-red-600">{errors.n2oFactor}</div>
                                ) : null}
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="mt-6 rounded-2xl bg-white/60 p-4 ring-1 ring-black/5 shadow-[0_18px_50px_-45px_rgba(15,23,42,0.28)]">
                        ...
                        <div className="mt-3 grid grid-cols-1 gap-3 sm:grid-cols-3">
                            <div>
                                ...
                                />
                                {errors.source ? (
                                    <div className="mt-1 text-[12px] text-red-600">{errors.source}</div>
                                ) : null}
                            </div>
                            <div>
                                ...
                                />
                                {errors.gwpBasis ? (
                                    <div className="mt-1 text-[12px] text-red-600">{errors.gwpBasis}</div>
                                ) : null}
                            </div>
                            <div>
                                ...
                                />
                                {errors.version ? (
                                    <div className="mt-1 text-[12px] text-red-600">{errors.version}</div>
                                ) : null}
                            </div>
                        </div>
                    </div>
                        ...
                        <div className="overflow-auto">
                            <table className="min-w-[920px] w-full text-sm">
                                ...
                                <tbody>
                                    {paged.map((f) => {
                                        return (
                                            <tr key={f.id} className="border-t border-black/5 hover:bg-black/2">
                        ...
                        <div className="rounded-2xl border border-black/5 bg-white/60 p-4">
                            <div className="flex items-start justify-between gap-4">
                                <div>
                                    ...
                                    <div className={helpTextClass()}>
                                        Uploads to{" "}
                                        <span className="font-mono">POST /factor/superAdmin/uploadFactor</span>.
                                    </div>
                                </div>
                                <button
                                    type="button"
                        ...
                        <div className="rounded-2xl border border-black/5 bg-white/60 p-4">
                            ...
                            {uploadResult ? (
                                <div
                                    ...
                                    <pre className="mt-2 whitespace-pre-wrap text-[12px] leading-5 text-(--muted)">
                                        {JSON.stringify(
                                            uploadResult.body ?? { message: uploadResult.message },
                                            null,
                                            2,
                                        )}
                                    </pre>
                            ...
                            <div className="mt-4 rounded-xl border border-black/10 bg-white p-3">
                                ...
                                <div className={["mt-1", helpTextClass()].join(" ")}>
                                    ...
                                    <span className="font-mono">Fuel</span>, <span className="font-mono">Unit</span>,
                                    multiple <span className="font-mono">kg CO2e</span> columns, emission standard,
                                    year, source type, version, output unit. The backend decides the exact mapping.
                                </div>
                            </div>
                        </div>
                    </div>
