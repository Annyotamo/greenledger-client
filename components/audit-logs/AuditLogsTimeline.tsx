...
export function AuditLogsTimeline({ initialLogs = [] }: AuditLogsTimelineProps) {
                                ...
                                <motion.div
                                    ...
                                    {logs.map((log, index) => (
                                        <motion.div key={log.id} variants={itemVariants}>
                                            <AuditLogTimelineItem log={log} isLast={index === logs.length - 1} />
                                        </motion.div>
                                    ))}
                                </motion.div>
                            </div>
