        ...
        <div className="gl-card p-6">
            <div className="flex flex-wrap items-start justify-between gap-3">
                <div>
                    ...
                    <p className="mt-1 text-sm text-(--muted)">Add version-specific Scope 2 emission factors.</p>
                </div>
                <button
                    type="button"
                    onClick={() => {
            ...
            <div className="mt-5 rounded-2xl bg-white/60 p-4 ring-1 ring-black/5 shadow-[0_18px_50px_-45px_rgba(15,23,42,0.28)]">
                <div className="grid gap-4 sm:grid-cols-2">
                    <div>
                        ...
                        />
                        {errors.factorSource ? (
                            <p className="mt-1 text-[12px] text-red-600">{errors.factorSource}</p>
                        ) : null}
                    </div>
                ...
                <div
                    className={[
                        ...
                        result.ok
                            ...
                            : "bg-red-50/70 ring-red-200 text-red-900",
                    ].join(" ")}>
                    <p className="font-semibold">
                        {result.ok ? "Saved successfully." : "Couldn’t save."}
                        {typeof result.status === "number" ? (
                            <span className="text-black/40"> (HTTP {result.status})</span>
                        ) : null}
                    </p>
                    {!result.ok ? (
