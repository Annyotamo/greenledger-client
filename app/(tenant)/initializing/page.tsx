...
export default function InitializingPage() {
    ...
    // Preload image assets fully before rendering the card layout
    useEffect(() => {
        if (!tenant) return;
    ...
    if (isLoading || !tenant || !imagesLoaded) {
        return (
            <div className="flex h-screen w-screen flex-col items-center justify-center bg-[#f4f7f6] text-on-surface">
                <div className="h-10 w-10 animate-spin rounded-full border-4 border-primary/20 border-t-primary" />
                <p className="mt-4 text-sm font-semibold text-on-surface-variant animate-pulse font-sans">
