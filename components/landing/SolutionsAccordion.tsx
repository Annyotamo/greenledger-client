...
function Chevron({ open }: { open: boolean }) {
    return (
        <m.span
            className="mt-0.5 flex h-11 w-11 shrink-0 items-center justify-center rounded-xl border border-emerald-900/10 bg-white/95 text-emerald-800 shadow-sm"
            aria-hidden
...
function SolutionsAccordionInner({ items }: SolutionsAccordionProps) {
                    ...
                    return (
                        <div
                            ...
                            <button
                                ...
                                <span className="flex h-11 w-11 shrink-0 items-center justify-center rounded-xl bg-emerald-900/6 text-sm font-bold tabular-nums text-emerald-800">
                                    {String(index + 1).padStart(2, "0")}
                                </span>
                                <span className="min-w-0 flex-1 pt-1">
                                    <span className="block text-lg font-semibold tracking-tight text-emerald-950">
                                        {item.title}
                                    </span>
                            ...
                            {open ? (
                                <m.div
                                    ...
                                    className="border-t border-emerald-900/6 bg-linear-to-b from-white/50 to-emerald-50/25 px-5 pb-6 pt-4 text-sm leading-relaxed text-slate-700 sm:px-6"
...
export const SolutionsAccordion = memo(SolutionsAccordionInner);
