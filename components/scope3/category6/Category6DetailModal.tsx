            ...
            <div className="relative w-full max-w-2xl overflow-hidden rounded-2xl border border-outline-variant bg-surface-container-lowest shadow-2xl z-10 p-6 space-y-6 my-auto">
                ...
                <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
                    <div className="rounded-xl bg-surface-container-low p-4 border border-outline-variant/40 space-y-2 font-sans text-xs">
                        <span className="text-[11px] font-semibold uppercase tracking-wider text-slate-500 block mb-1">Journey Overview</span>
                        <div className="flex justify-between"><span className="text-slate-500">Total Segments:</span><span className="font-semibold text-slate-900">{entry.trips.length} trip leg(s)</span></div>
                    ...
                    <div className="rounded-xl bg-surface-container-low p-4 border border-outline-variant/40 space-y-2 font-sans text-xs">
                        <span className="text-[11px] font-semibold uppercase tracking-wider text-slate-500 block mb-1">GHG Protocol Gas Breakdown</span>
                ...
                <div className="space-y-2 font-sans text-xs">
                    <span className="font-semibold text-slate-900 uppercase text-[11px] tracking-wider">Itemized Trip Segments ({entry.trips.length})</span>
                            ...
                            <tbody>
                                {entry.trips.map((t, idx) => (
                                    <tr key={idx} className="border-b border-outline-variant/20">
                                        ...
                                        <td className="p-2.5">
                                            <span className="rounded bg-surface-container-high px-1.5 py-0.5 text-[10px] font-semibold text-slate-700 uppercase">
                                                {t.transportMode}
                                            </span>
                                        </td>
