                            ...
                            entries.map((entry) => {
                                ...
                                return (
                                    <TableRow
                                        ...
                                        <TableCell className="py-3 px-4">
                                            <div className="font-bold text-primary">{entry.whatYouFinanced}</div>
                                            <div className="flex items-center gap-1 mt-0.5">
                                                <span className="flex h-4 w-4 items-center justify-center rounded bg-secondary/15 text-[9px] font-bold text-secondary">
                                                    #{entry.assetClassNo}
                                                </span>
                                                <span className="text-[10px] text-on-surface-variant font-medium truncate max-w-xs">
