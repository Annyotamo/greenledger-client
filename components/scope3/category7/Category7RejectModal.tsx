...
interface Category7RejectModalProps {
    isOpen: boolean;
    onClose: () => void;
...
export function Category7RejectModal({
    isOpen,
    onClose,
    onConfirm,
    isSubmitting,
}: Category7RejectModalProps) {
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 sm:p-6 overflow-y-auto font-sans">
            ...
            <div className="relative w-full max-w-md overflow-hidden rounded-2xl border border-outline-variant bg-surface-container-lowest shadow-2xl z-10 p-6 space-y-4 my-auto">
                <div className="flex items-center gap-3 text-error">
                    ...
                    <div>
                        <h3 className="font-display text-lg font-bold text-primary tracking-tight">Reject Commute Record</h3>
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                    <div>
                        ...
                        <textarea
                            ...
                            placeholder="e.g. Employee commuting survey data or pass verification missing..."
