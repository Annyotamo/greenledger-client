...
interface Category3RejectModalProps {
    isOpen: boolean;
    title: string;
    onClose: () => void;
...
export function Category3RejectModal({
    isOpen,
    title,
    onClose,
    onConfirm,
    isSubmitting,
}: Category3RejectModalProps) {
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 sm:p-6 overflow-y-auto">
            ...
            <div className="relative w-full max-w-md overflow-hidden rounded-2xl border border-outline-variant bg-surface-container-lowest shadow-2xl z-10 p-6 space-y-4 my-auto">
                <div className="flex items-center gap-3 text-error">
                    ...
                    <div>
                        <h3 className="font-mono text-headline-sm font-bold text-primary">{title}</h3>
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                    <div>
                        ...
                        <textarea
                            ...
                            placeholder="e.g. Fuel consumption quantity or grid meter evidence is missing..."
