            ...
            <div className="relative w-full max-w-2xl overflow-hidden rounded-2xl border border-outline-variant bg-surface-container-lowest shadow-2xl z-10 p-6 space-y-6 my-auto">
                ...
                <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
                    <div className="rounded-xl bg-surface-container-low p-4 border border-outline-variant/40 space-y-2 font-mono text-xs">
                        <span className="text-[10px] font-bold uppercase text-on-surface-variant">Commute Overview</span>
                        <div className="flex justify-between"><span className="text-on-surface-variant">Total Commute Legs:</span><span className="font-bold text-primary">{entry.trips.length} leg(s)</span></div>
                    ...
                    <div className="rounded-xl bg-surface-container-low p-4 border border-outline-variant/40 space-y-2 font-mono text-xs">
                        <span className="text-[10px] font-bold uppercase text-on-surface-variant">Gas Breakdown</span>
                ...
                <div className="space-y-2 font-mono text-xs">
                    <span className="font-bold text-primary uppercase text-[11px]">Itemized Commute Legs ({entry.trips.length})</span>
