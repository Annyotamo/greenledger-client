...
const DEFAULT_FIELD_LABELS: Record<string, string> = {
    ...
    notes: "Notes",
    // Market-Based Accounting Labels
    accountingMethod: "Accounting Method",
    contractedElectricityKwh: "Contracted Electricity (kWh)",
    contractedEmissionFactor: "Contracted Emission Factor",
    contractedEmissionFactorUnit: "Emission Factor Unit",
    uncoveredElectricityKwh: "Uncovered Electricity (kWh)",
    supplierName: "Supplier Name",
    certSerialNumber: "Certificate Serial Number",
    certDateAcquired: "Acquisition Date",
    certExpirationDate: "Expiration Date",
    certQuantity: "Certificate Volume",
    certReference: "Certificate Reference",
    purchasedEnergyUnit: "Purchased Energy Unit",
    steam: "Steam Quantity",
    steamEmissionFactor: "Steam Emission Factor",
    heating: "Heating Quantity",
    heatingEmissionFactor: "Heating Emission Factor",
    cooling: "Cooling Quantity",
    coolingEmissionFactor: "Cooling Emission Factor",
    purchasedEnergyEfUnit: "Purchased Energy Factor Unit",
