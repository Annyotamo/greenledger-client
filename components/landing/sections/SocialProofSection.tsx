    ...
    return (
        <section className="section-bg rounded-2xl border border-white/50 p-6 shadow-lg sm:p-8 md:p-9">
            ...
            <p className="mt-5 max-w-4xl text-sm leading-relaxed text-slate-700 sm:text-base">
                ...
                data; procurement leads run structured supplier programs. When disclosure season arrives, everyone is
                looking at the same numbers and when a customer scans a code, that story still holds.
            </p>
